    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "Validation failed (e.g., id, login-name, e-mail or bean validation errors)."
                    )
            }
    )
    @PostMapping("")
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "Validation failed: IDs in path and body do not match, invalid name, login-name, or bean validation errors."
                    ),
                    @ApiResponse(
                            responseCode = "404",
                            content = @Content(
